...
@property (nonatomic , strong , readonly) FMDatabase *dbDatabase;
 ...
 *  @param tableName 表名
 *  @param condition 查询条件的字段名及其对应的值
 *
 ...
 *  @return 是否存在
 */
- (BOOL)isExistsRowWithTableName:(NSString *)tableName fieldName:(NSString *)fieldName value:(NSString *)value;
