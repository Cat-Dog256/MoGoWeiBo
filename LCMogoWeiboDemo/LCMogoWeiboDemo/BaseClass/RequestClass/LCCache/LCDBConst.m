...
//json数据的类型
NSString * const kJsonType = @"dataType";
// kDictionary
NSString * const kCahceDictionary = @"NSDictionary";
// kArray
NSString * const kCacheArray = @"NSArray";
...
//REPLACE INTO 插入
NSString * const kReplaceInto = @"REPLACE INTO";
//ORDER BY
